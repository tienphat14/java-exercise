...
public class Employees {
    ...
    private static String randomPostCode() {
        ...
        IntSupplier randomDigit = () -> RANDOM.nextInt(9);
        return "" + randomLetter.get() + randomLetter.get() + randomDigit.getAsInt() + randomDigit.getAsInt() + " " + randomDigit.getAsInt() + randomLetter.get() + randomLetter.get();
    }
